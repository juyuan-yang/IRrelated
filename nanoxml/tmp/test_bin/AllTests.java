...
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(NanoCheckChildren1_wy_v1Tests.class);
		suite.addTestSuite(NanoCheckChildren2_wy_v1Tests.class);
		suite.addTestSuite(NanoCheckChildren3_wy_v1Tests.class);
		suite.addTestSuite(NanoCheckLeaf1_wy_v1Tests.class);
		suite.addTestSuite(NanoCheckLeaf2_wy_v1Tests.class);
		suite.addTestSuite(NanoCheckLeaf3_wy_v1Tests.class);
//		suite.addTestSuite(NanoCrElement1_wy_v1Tests.class);
//		suite.addTestSuite(NanoCrElement2_wy_v1Tests.class);
//		suite.addTestSuite(NanoCrElement3_wy_v1Tests.class);
		suite.addTestSuite(NanoParser1_vw_v1Tests.class);
		//suite.addTestSuite(NanoParser2_vw_v1Tests.class);
		suite.addTestSuite(NanoParser3_vw_v1Tests.class);
		suite.addTestSuite(NanoParser4_vw_v1Tests.class);
		suite.addTestSuite(NanoParser5_vw_v1Tests.class);
		suite.addTestSuite(NanoParser6_vw_v1Tests.class);
...
//		suite.addTestSuite(NanoRChildAtIndex2_wy_v1Tests.class);
		...
		suite.addTestSuite(NanoRemoveChild2_wy_v1Tests.class);
...
//		suite.addTestSuite(NanoRemoveChildIndex3_wy_v1Tests.class);
		...
		suite.addTestSuite(NanoREnumChildren_wy_v1Tests.class);
		//suite.addTestSuite(NanoRFirstChild1_wy_v1Tests.class);
		suite.addTestSuite(NanoRFirstChild2_wy_v1Tests.class);
		suite.addTestSuite(NanoRFirstChild3_wy_v1Tests.class);
		suite.addTestSuite(NanoRFirstChild4_wy_v1Tests.class);
		suite.addTestSuite(NanoRPropAttr_wy_v1Tests.class);
		//suite.addTestSuite(NanoRVecChildNamed1_wy_v1Tests.class);
		suite.addTestSuite(NanoRVecChildNamed2_wy_v1Tests.class);
		suite.addTestSuite(NanoRVecChildNamed3_wy_v1Tests.class);
		suite.addTestSuite(NanoRVecChildren_wy_v1Tests.class);
		...
		suite.addTestSuite(NanoWriter4_wy_v1Tests.class);
		suite.addTestSuite(NanoWriter5_wy_v1Tests.class);
		suite.addTestSuite(NanoWriter6_wy_v1Tests.class);
