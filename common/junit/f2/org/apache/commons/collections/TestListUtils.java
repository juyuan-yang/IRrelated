...
public class TestListUtils extends BulkTest {
     ...
     */
	 public void testIntersectionOrderInsensitivity_1() {
	 ...
	 two.add("b");
	 two.add("b");
	 assertEquals(ListUtils.intersection(one,two), one);
	 }

	public void testIntersectionOrderInsensitivity_2() {
		List one = new ArrayList();
		List two = new ArrayList();
		one.add("a");
		one.add("a");
	...
	public void testIntersectionOrderInsensitivity_3() {
		List one = new ArrayList();
		List two = new ArrayList();
		...
		two.add("e");
		result.add("a");
		assertEquals(ListUtils.intersection(one, two), result);
	}
	
	public void testIntersectionOrderInsensitivity_4() {
		List one = new ArrayList();
		List two = new ArrayList();
		one.add("a");
		one.add("b");
		...
		two.add("a");
		two.add("c");
		assertEquals(ListUtils.intersection(one, two), two);
	}
}
